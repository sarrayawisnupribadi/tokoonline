            ...
            <div class="card-body">
                <form method="POST" action="proses_ubah_produk.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_produk" value="<?=$data_produk['nama_produk']?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" row="3" required><?=$data_produk['deskripsi']?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga</label>
                        <input type="text" class="form-control" name="harga" value="<?=$data_produk['pengarang']?>" required>
                    </div>
                    <div class="mb-3">
