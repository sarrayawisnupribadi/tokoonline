  ...
  <body style="background-image: url(polos.png)">
    ...
    <section class="py-5 text-center container">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light" style="font-family: internet friends;">Produk</h1>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="col">
            <div class="card shadow-sm" >
                <img src="../petugas/foto/<?=$data_produk['foto']?>" class="bd-placeholder-img card-img-top" width="100px" height="400px" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
